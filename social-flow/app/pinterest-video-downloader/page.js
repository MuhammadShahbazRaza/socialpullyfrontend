          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '56px', alignItems: 'center' }}>
            <div>
              <h2 style={{ fontFamily: FONT, fontWeight: 800, fontSize: 'clamp(1.7rem, 3.2vw, 2.3rem)', color: '#0a0a0a', marginBottom: '14px', letterSpacing: '-0.02em' }}>
                Best Pinterest Video Downloader Online
              </h2>
              <p style={{ color: '#6b7280', lineHeight: '1.78', marginBottom: '30px' }}>
                Download Pinterest videos online free using SocialPully&apos;s fast and reliable Pinterest video downloader. Save Pinterest videos and GIFs in HD quality directly to your device. No app installation, no login required — just paste the pin URL and download instantly.
              </p>
              <ScrollToTopButton style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: `linear-gradient(135deg, ${PINTEREST_RED} 0%, ${PINTEREST_DARK} 100%)`, color: '#fff', padding: '14px 28px', borderRadius: '12px', fontFamily: FONT, fontWeight: 700, fontSize: '0.95rem', boxShadow: '0 8px 30px rgba(230,0,35,0.35)', border: 'none', cursor: 'pointer' }}>
                ⬇️ Download Pinterest Video Free
              </ScrollToTopButton>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              {[
                { label: 'Videos & GIFs', desc: 'Download both Pinterest videos and animated GIFs in MP4' },
                ...
                { label: 'No App Required', desc: 'Pinterest video downloader online works directly in browser' },
                { label: 'Unlimited Downloads', desc: 'Download Pinterest videos as many times as you want' },
                ...
                <div key={item.label} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', padding: '12px 0', borderBottom: '1px solid #f3f4f6' }}>
                  <span style={{ color: PINTEREST_RED, fontWeight: 800, fontSize: '1.1rem', marginTop: '1px', flexShrink: 0 }}>✓</span>
                  <div>
